...
async function fetchSites() {
  let sitesUrl =
    'https://data.nsw.gov.au/data/dataset/0a52e6c1-bc0b-48af-8b45-d791a6d8e289/resource/f3a28eed-8c2a-437b-8ac1-2dab3cf760f9/download/covid-case-locations.json';
...
async function updateSites() {
  ...
  let sites = await fetchSites().catch((error) => {
  ...
  let numPages = Math.floor(sites.length / PAGE_SIZE);
  numPages = Math.max(1, numPages); // ensure that it's at least 1
